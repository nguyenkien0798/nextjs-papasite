        ...
        <div className="h-[100%] w-[100%] rounded-[16px] bg-navy-5">
          <div className="p-[16px]">
            ...
            <div className="max-h-[500px] overflow-y-auto px-[16px] py-[20px]">
              ...
              >
                <select
                  className="h-[48px] rounded-[12px] border-2 border-solid border-[#5D70AB] bg-['0f103c'] px-[12px] text-[16px] font-normal leading-[22px]"
                  value={valuePackage}
                  onChange={(e) => handleChangePackage(e)}
                >
                  <option value={'basic'}>CLOUD SERVER BASIC</option>
                  <option value={'standar'}>CLOUD SERVER STANDAR</option>
                  <option value={'professional'}>
                    CLOUD SERVER PROFESSIONAL
                  </option>
                  <option value={'vip'}>CLOUD SERVER VIP</option>
                </select>
              </FormControl>
              {/*-----------------------------Time-----------------------------*/}
              <Typography
