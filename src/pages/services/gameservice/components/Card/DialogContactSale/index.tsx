          ...
          <div className="p-[16px]">
            ...
            <div className="max-h-[500px] overflow-y-auto px-[16px] py-[20px]">
              ...
              <FormControl sx={{ minWidth: '100%', minHeight: '48px' }}>
                ...
                >
                  <option value={'argame'}>AR Game</option>
                  <option value={'mobagame'}>MOBA GAME</option>
                  <option value={'farmergame'}>FARMER GAME</option>
                </select>
              </FormControl>
              {/*-----------------------------Time-----------------------------*/}
              <Typography
            ...
            {/*-----------------------------Submit-----------------------------*/}
            <div className="mt-[20px] flex justify-center px-[16px]">
              <button className="w-[40%] rounded-[10px] bg-active py-[12px] text-[18px] font-semibold leading-[24px] text-navy-5">
                Submit
              </button>
            </div>
          </div>
